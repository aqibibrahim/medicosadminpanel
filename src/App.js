...
import { isMultiColorActive, adminRoot, UserRole, servicePath } from "./constants/defaultValues";
import { getDirection } from "./helpers/Utils";
import { ProtectedRoute } from "./helpers/authHelper";
import axios from "axios";

axios.defaults.baseURL = servicePath;
axios.defaults.headers.common["x-access-token"] = JSON.parse(localStorage?.getItem("current_user"))?.token;
