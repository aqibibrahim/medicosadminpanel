...
const data = [
    ...
    subs: [
      ...
      },
      {
        ...
        subs: [
          ...
          {
            icon: "simple-icon-book-open",
            label: "menu.details-alt2",
            to: `${adminRoot}/pages/product/details-alt2`,
          },
        ],
      },
      // {
      ...
      // }
      {
        ...
        subs: [
          ...
          // },
          {
            ...
            label: "menu.Profession",
            to: `${adminRoot}/pages/profile/Profession`,
          },
        ],
      },
      // {
  ...
  },
  {
    ...
    subs: [
      ...
      {
        icon: "simple-icon-check",
        label: "menu.Productads",
        to: `${adminRoot}/applications/Productads`,
      },

      {
        icon: "simple-icon-check",
        label: "menu.productCategories",
        to: `${adminRoot}/applications/productCategories`,
      },
      // {
