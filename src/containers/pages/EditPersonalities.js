...
// const EditPersonalities = ({ modalOpen, toggleModal, value, id }) => {
...
//     axios
//       .put(
//         '/admin/connect/interests/personality/update',
//         { id, name: inputvalue },
//         {
//           headers: {
...
//         </Button>
//         <Button color="primary" onClick={editPersonality}>
