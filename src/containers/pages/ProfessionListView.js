...
// const ProfessionListView = ({ product, isSelect, collect }) => {
...
//                     onClick={() => {
//                       console.log(
//                         `/admin/connect/profession/${product.id}`
//                       );
//                       axios
//                         .delete(
//                           `/admin/connect/profession/${product.id}`,
...
//         value={product.title}
//         id={product.id}
//         toggleModal={() => setModelOpen(false)}
//       />
//     </Colxx>
//   );
// };
...
// export default React.memo(ProfessionListView);
