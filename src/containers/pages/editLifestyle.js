...
// const Editlifestyle = ({ modalOpen, toggleModal, value, id }) => {
...
//     axios
//       .put(
//         '/admin/connect/interests/lifestyle/update',
//         { id, name: inputvalue },
//         {
//           headers: {
...
//         </Button>
//         <Button color="primary" onClick={editlifestyle}>
