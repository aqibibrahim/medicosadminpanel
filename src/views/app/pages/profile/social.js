            ...
            <TabPane tabId="profile">
              <Row>
                  ...
                  <Card className="mb-4">
                    <CardBody>
                      ...
                      <p className="mb-3">
                        ...
                        and JavaScript; dabbling with Python and Ruby; and inhaling a wide variety of potentially
                        useless information through a few hundred RSS feeds. I build websites that delight and inform. I
                        do it well.
                      </p>
                    ...
                    <CardBody>
                      ...
                      <div className="remove-last-border remove-last-margin remove-last-padding">
                        {followData.map((itemData) => {
                          return <UserFollow data={itemData} key={`follow_${itemData.key}`} />;
                        })}
                      </div>
                    </CardBody>
                  </Card>
                    ...
                    <CardBody>
                      ...
                      <div className="remove-last-border remove-last-margin remove-last-padding">
                        {recentPostsData.map((itemData) => {
                          return <RecentPost data={itemData} key={`recent_${itemData.key}`} />;
                        })}
                      </div>
                    </CardBody>
                  </Card>
                ...
                <Colxx xxs="12" lg="7" xl="8" className="col-right">
                  {posts.map((itemData) => {
                    return <Post data={itemData} key={`post_${itemData.key}`} className="mb-4" />;
                  })}
                </Colxx>
              </Row>
            </TabPane>
            ...
            <TabPane tabId="friends">
              <Row>
                {friendsData.map((itemData) => {
                  return (
                    <Colxx xxs="12" md="6" lg="4" key={`friend_${itemData.key}`}>
