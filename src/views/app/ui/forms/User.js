            ...
            <CardBody>
              ...
              <Form>
                <FormGroup>
                  ...
                  <Input type="email" name="email" id="exampleEmail" placeholder={messages["forms.email"]} />
            ...
            <CardBody>
              ...
              <Form>
                <FormGroup row>
                  ...
                  <Colxx sm={10}>
                    <Input type="email" name="email" id="emailHorizontal" placeholder={messages["forms.email"]} />
                  </Colxx>
                </FormGroup>
          ...
          <Card>
            <CardBody>
              ...
              <Form>
                ...
                <div className="form-group has-float-label">
                  <DatePicker selected={startDateLO} onChange={(val) => setStartDateLO(val)} />
                  <span>
            ...
            <CardBody>
              ...
              <Form>
                ...
                <FormGroup className="form-group has-top-label">
                  ...
                  <TagsInput value={tagsLT} onChange={(val) => setTagsLT(val)} inputProps={{ placeholder: "" }} />
                </FormGroup>
                <FormGroup className="form-group has-top-label">
                  <Label>
                    <IntlMessages id="forms.date-u" />
                  </Label>
                  <DatePicker shouldCloseOnSelect selected={startDateLT} onChange={(val) => setStartDateLT(val)} />
                </FormGroup>
